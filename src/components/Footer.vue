...
interface Navigation {
  ...
  company: NavItem[];
  legal: NavItem[];
  social: (NavItem & { icon: ReturnType<typeof defineComponent> })[];
}
...
<template>
  <footer class="bg-white dark:bg-gray-900">
    <div class="mx-0 p-4 sm:p-6 lg:p-8">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <PalmTree class="h-10 w-10 text-[#50A9E4]" />
      ...
      <div
        class="mt-16 border-t border-gray-900/10 dark:border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between"
      >
        <div>
          <h3 class="text-sm/6 font-semibold text-gray-900 dark:text-white">
        ...
        <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
          ...
          <input
            ...
            autocomplete="email"
            required=""
            class="w-full min-w-0 rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[#2E8ECE] dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-[#6EC0FF] sm:w-56 sm:text-sm/6"
      ...
      <div
        class="mt-8 border-t border-gray-900/10 dark:border-white/10 pt-8 md:flex md:items-center md:justify-between"
      >
        ...
        <p
          class="mt-8 text-sm/6 text-gray-600 dark:text-gray-400 md:order-1 md:mt-0"
        >
